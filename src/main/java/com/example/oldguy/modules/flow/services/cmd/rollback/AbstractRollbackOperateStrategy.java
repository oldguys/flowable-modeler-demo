...
import com.example.oldguy.modules.app.dao.jpas.HistoryActivityInstanceMapper;
 ...
 * @Author: huangrenhao
 * @Description:
 * @CreateTime： 2020/3/25 0025 下午 4:01
 * @Version：
 **/
@Slf4j
public abstract class AbstractRollbackOperateStrategy implements RollbackOperateStrategy {
    ...
    public AbstractRollbackOperateStrategy(RollbackParamsTemplate paramsTemplate) {
        ...
        this.historyActivityInstanceMapper = SpringContextUtils.getBean(HistoryActivityInstanceMapper.class);
    ...
    protected ExecutionEntity getExecutionEntity() {
        ...
        if (null == executionEntity) {
            ...
            if (executionEntityList.isEmpty()) {
                throw new FlowRuntimeException("没有找到临近节点");
            }
